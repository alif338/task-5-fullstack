              ...
              <div class="card-body">
                <form id="article" method="POST" action="{{route('articles.update', ['article' => $article])}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <textarea name="content" form="article" class="form-control @error('content') is-invalid @enderror" value="{{$article->content}}" required autofocus>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="image" type="text" class="form-control @error('image') is-invalid @enderror" name="image" value="{{$article->image}}" required autofocus>
